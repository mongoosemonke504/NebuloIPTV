...
class UpdateService: ObservableObject {
    ...
    /// "V3.0.0" — the version this build really is, read from the bundle
    /// (MARKETING_VERSION). It used to be typed in here by hand, so every
    /// version bump had to remember this line too, or the comparison with
    /// the latest GitHub release was made against the wrong number.
    @Published var currentVersion: String = UpdateService.bundleVersion
