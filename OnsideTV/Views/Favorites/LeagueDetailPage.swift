...
struct LeagueDetailPage: View {
    ...
    var body: some View {
        ZStack(alignment: .top) {
            ...
            // team page and the hubs got: with one shared scroll and the tab
            // swapped in by identity, a swipe cannot show you the tab you are
            // swiping towards. The hero and chip row float over the pages and
            // slide away with the active page's scroll, exactly as they
            // scrolled away before.
    ...
    /// The hero and the chip row, floating over the pages. They slide away
    /// entirely with the scroll, as they did when they were scroll content.
